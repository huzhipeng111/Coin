...
//            FileLog.e(e);
    ...
    public static void runOnUIThread(Runnable runnable, long delay) {
        if (delay == 0) {
            AppConfig.instance.getApplicationHandler().post(runnable);
        } else {
            AppConfig.instance.getApplicationHandler().postDelayed(runnable, delay);
        }
    }

    public static void cancelRunOnUIThread(Runnable runnable) {
        AppConfig.instance.getApplicationHandler().removeCallbacks(runnable);
    }
